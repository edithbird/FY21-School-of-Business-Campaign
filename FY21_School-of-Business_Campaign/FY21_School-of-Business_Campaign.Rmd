---
title: "FY21 School of Business Campaign"
...
`r newthought('Intro text here')` Intro text here Intro text here Intro text here Intro text here Intro text here Intro text here Intro text here Intro text here. In general,we are advertising through Programmatic, FB/IG Display and FB/IG and SC video.
    \href{https://docs.google.com/spreadsheets/d/1Nmwj3jWkmdYrEG7Jq1XSKUVlFan9udn8gbOCYIZSKuc/edit#gid=1224998348}{{\color{blue}{\underline{Naming conventions are here.}}}} CTR overall experienced a 24% drop from July, 2017 - July, 2018.
...
\href{https://www.wrike.com/open.htm?id=534861027}{{\color{blue}{\underline{Wrike Project Details}}}}

\href{git@github.com:edithbird/FY21-School-of-Business-Campaign.git}{{\color{blue}{\underline{Github Repository}}}}
